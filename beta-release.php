...
<section class="center pure-g-r">
    <article class="pure-u-1">
        ...
        <h2 id="beta2">Release am 17. Oktober 2016 (Beta-Version 2)</h2>
        ...
        <ul>
            ...
            <li>Die <a href="archive_prints">Liste der Drucke</a> ist chronologisch sortiert.</li>
            <li>Unter „Archiv“ ist eine Liste der <a href="archive_testimonies">Dokumente zur Entstehungsgeschichte</a> abrufbar, an der zurzeit noch gearbeitet wird.</li>
            <li>Beim Blättern in der Handschriftenansicht werden leere Seiten übersprungen.</li>
            <li>Die angezeigte Information über die Wasserzeichen ist vereinheitlicht worden. Dies geschah unter nochmaliger Rücksprache mit <a href="credits_coop">Andrea Lothe</a>.</li>
        ...
        <h3>Text</h3>
        <ul>
            <li>Im Bereich „Text“ ist eine Liste der sogenannten <a href="paralipomena">Paralipomena</a> nach der Zählung in der Weimarer Ausgabe 
            (<a href="bibliography#wa_I_14">WA I 14</a> und <a href="bibliography#wa_I_15_2">WA I 15.2</a>) abrufbar. In den textuellen Transkriptionen 
            ...
            (z.B. <a href="http://dev.faustedition.net/print/faust1.17#l3356%203357">Faust I, Vers 3356f.</a>).</li>
            <li>In den Varianten zur Szene ‚<a href="###">Trüber Tag. Feld</a>‘ erscheint nun auch der ‚Urfaust‘ 
            (<a href="documentViewer?faustUri=faust://xml/document/faust/0/gsa_390028.xml&page=85&view=facsimile_document">1 H.5</a>).</li>
        </ul>
        <h3>Suche</h3>
        <ul>
            ...
            <li>Auch nach Zeugensiglen und Archivsignaturen kann nun gesucht werden, siehe <a href="intro#volltextsuche">Volltextsuche</a>.</li>
        </ul>
        <h3>Sonstiges</h3>
        <p>Über die genannten hinaus wurden u.a. folgende Verbesserungen vorgenommen:</p>
        <ul>
            <li>korrekte Sortierung der <a href="bibliography">Bibliographie</a></li>
