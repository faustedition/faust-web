...
<section class="center pure-g-r">
    <article class="pure-u-1">
        ...
        <p>Die Ausgabe bietet einen neu konstituierten Text des Dramas, erstellt auf der Grundlage
            ...
            Trag�die�. �Zueignung�, �Vorspiel auf dem Theater� und �Prolog im Himmel� sind den
            beiden Teilen �Der Trag�die erster Teil� und �Der Trag�die zweiter Teil in f�nf Akten�
            vorangestellt. Die Textbehandlung der vorliegenden Ausgabe folgt bei beiden Teilen des
            Faust denselben Grunds�tzen. Ziel der Textkonstitution ist es, den letzten autornahen
            Textzustand, der sich erreichen l�sst, in emendierter Form wiederzugeben. Im Fall sowohl
            von Faust I wie auch von Faust II ist der jeweils letzte autornahe Textzustand nicht
            direkt �berliefert; er l�sst sich jedoch in beiden F�llen durch textkritische Analyse
            der �berlieferung rekonstruieren. Der konstituierte Text ist das Ergebnis der
            Rekonstruktion des letzten autornahen Textzustandes und dessen Emendation von
            �berlieferungsst�rungen. Konjekturen werden nicht in den konstituierten Text
            aufgenommen. Zu den Grunds�tzen der Textbehandlung vgl. den <a ref="intro_text"
        ...
        <p>Bei der Darstellung des konstituierten Textes gelten dieselben Prinzipien
            wie bei den textuellen Transkriptionen in Form der <a ref="transcription_guidelines.php#txt_transcr_last">letzten
                abhebbaren Stufe</a>. Im Unterschied zu den übrigen Textwiedergaben sind die
        ...
        <p>Die Zeilen des konstituierten Textes sind grau unterlegt, wenn abweichende Fassungen
            ...
            vor (Grad und Art der Abweichung wirken sich nicht auf die Intensit�t der Unterlegung
            aus). Die Intensit�t der Einf�rbung des gelben Balkens am rechten Rand l�sst auf die
            Anzahl der �berlieferten Fassungen schlie�en. Per Klick auf die Zeile l�sst sich eine
            ...
            �berliefert ist. Ein Klick auf eine der Siglen f�hrt zur textuellen Transkription des
            Zeugen in Form der <a ref="transcription_guidelines.php#txt_transcr_last">letzten
                abhebbaren Stufe</a>. Von dort ausgehend k�nnen wiederum zu jeder Zeile die anderen
            �berlieferten Fassungen sowie die Fassung des konstituierten Texts aufgerufen
            werden.</p>
