        ...
        return function(pageNum) {
          ...
          if(sceneData !== undefined) {
            ...
            if(sceneData.id.split(".")[0] === "1") {
              breadcrumbs.appendChild(Faust.createBreadcrumbs([{caption: "Genese", link: "chessboard.php"}, {caption: "Faust I", link: "chessboard_faust_i.php"}, {caption: sceneData.title, link: "geneticBarGraph.php?rangeStart=" + sceneData.rangeStart + "&rangeEnd=" + sceneData.rangeEnd}, {caption: doc.sigil}]));
            } else {
              breadcrumbs.appendChild(Faust.createBreadcrumbs([{caption: "Genese", link: "chessboard.php"}, {caption: "Faust II", link: "chessboard_faust_ii.php"}, {caption: sceneData.title, link: "geneticBarGraph.php?rangeStart=" + sceneData.rangeStart + "&rangeEnd=" + sceneData.rangeEnd}, {caption: doc.sigil}]));
            }
          }
