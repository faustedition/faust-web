      <?php include "includes/header.php"; ?>
        <div id="main-content" class="main-content">
          <div style="width: 50em; margin: auto;">
            ...
            <h2 style="text-align: center; padding-top: 1.5em;">Handschriften</h2>
            ...
            <h2 style="text-align: center; padding-top: 1.5em;">Lesetext</h2>
            ...
            <h2 style="text-align: center; padding-top: 1.5em;">Siglen</h2>
            ...
            <h2 style="text-align: center; padding-top: 1.5em;">Projektleitung und -mitarbeiter</h2>
              <div style="width: 100%; display: flex;">
                <div>
                    ...
                    <p>
                      ...
                      <a href="mailto:abohnenkamp@goethehaus-frankfurt.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">abohnenkamp@goethehaus-frankfurt.de</a>
                    </p>
                    <p>
                      <strong style="font-weight: bold; font-style: normal;">Dr. Silke Henke</strong><br>
                      Klassik Stiftung Weimar<br>
                      Goethe- und Schiller-Archiv<br>
                      Hans-Wahl-Str. 4<br>
                      99425 Weimar<br>
                      Tel.: +49 (0)3643 / 545 255<br>
                      <a href="mailto:silke.henke@klassik-stiftung.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">silke.henke@klassik-stiftung.de</a>
                    </p>
                    <p>
                      <strong style="font-weight: bold; font-style: normal;">Prof. Dr. Fotis Jannidis</strong><br>
                      Universität Würzburg<br>
                      Am Hubland<br>
                      97074 Würzburg<br>
                      Tel: +49 (0)931 / 31 80078<br>
                      <a href="mailto:fotis.jannidis@uni-wuerzburg.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">fotis.jannidis@uni-wuerzburg.de</a>
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p>
                      <strong style="font-weight: bold; font-style: normal;">Dr. Katrin Henzel</strong><br>
                      <a href="mailto:henzel@faustedition.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">henzel@faustedition.de</a>
                    </p>
                    <p>
                      <strong style="font-weight: bold; font-style: normal;">Christoph Leijser</strong><br>
                      <a href="mailto:middell@faustedition.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">leijser@faustedition.de</a>
                    </p>
                    <p>
                      <strong style="font-weight: bold; font-style: normal;">Gregor Middell</strong><br>
                      <a href="mailto:middell@faustedition.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">middell@faustedition.de</a>
                    </p>
                    <p>
                      <strong style="font-weight: bold; font-style: normal;">Dr. Dietmar Pravida</strong><br>
                      <a href="mailto:pravida@faustedition.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">pravida@faustedition.de</a></p>
                    <p>
                      <strong style="font-weight: bold; font-style: normal;">Moritz Wissenbach</strong><br>
                      <a href="mailto:wissenbach@faustedition.de" title="E-Mail" style="color: rgb(0, 0, 0); font-weight: bold; text-decoration: none; cursor: pointer;">wissenbach@faustedition.de</a><br>
                    </p>
                    <br>
                    <h2>
                      Korrekturlesen<br>
                      ...
                      <strong>Wolfgang Ritschel</strong><br>
                    <br>
                    <h2>
            ...
            <h2 style="text-align: center; padding-top: 1.5em;">Zitierempfehlung</h2>
              <p>[Beispiel(e) für Zitieren aus der Ausgabe: Primärquellen, Texte]</p>
            <h2 id="updates" style="text-align: center; padding-top: 1.5em;">Updates</h2>
              <p>[Download aller verfügbaren Versionen der Ausgabe (oder Teilen davon)]</p>
